#!/usr/bin/env python
"""
Rubik's Cube Demo: Instantiate, Scramble, and Solve using Kociemba Algorithm

Kociemba's Algorithm is a two-phase algorithm that produces very efficient solutions:
- Phase 1: Get the cube into a specific subgroup (G1)
- Phase 2: Solve the cube within that subgroup

This is one of the most efficient solving algorithms, typically producing
solutions in 20 moves or less (God's Number is 20).

This script demonstrates:
1. Creating a solved Rubik's Cube
2. Scrambling it with random moves
3. Solving it using the Kociemba method (most efficient)
"""
...
def main():
    ...
    # Step 3: Solve the cube using Kociemba algorithm
    print("Step 3: Solving the cube using Kociemba's Algorithm...")
    print("         (Two-Phase: G0→G1→Solved)")
    print("         This may take a moment to compute the optimal solution...")
    ...
    print("=" * 60)
    print("SUCCESS! The cube has been solved using Kociemba's Algorithm!")
    print("Note: Kociemba's algorithm produces near-optimal solutions")
    print("      (typically ≤20 moves, often the most efficient method)")
    print("=" * 60)
