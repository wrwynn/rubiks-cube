#!/usr/bin/env python
"""
Rubik's Cube Demo: Instantiate, Scramble, and Solve using CFOP Algorithm

CFOP (Fridrich Method) stands for:
...
3. Solving it using the CFOP method (faster than Beginner's)
"""
...
def main():
    ...
    print("Using CFOP (Fridrich) Algorithm")
    print("=" * 60)
    print()
    ...
    # Step 3: Solve the cube using CFOP algorithm
    print("Step 3: Solving the cube using CFOP (Fridrich) Algorithm...")
    print("         (Cross → F2L → OLL → PLL)")
    ...
    print("=" * 60)
    print("SUCCESS! The cube has been solved using the CFOP Algorithm!")
    print("Note: CFOP is typically faster than the Beginner's method")
    print("=" * 60)
